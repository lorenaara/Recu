...
CREATE TABLE clase(
    ...
    id_claseC int,
    id_user int,
    CONSTRAINT FOREIGN KEY fk_tipoClase_clase (id_claseC) REFERENCES clase(id_claseC),
...
CREATE TABLE asiste(
  ...
  id_claseC int,
    ...
    clasificacion float,
    activo boolean,
    CONSTRAINT FOREIGN KEY fk_clase_asiste (id_claseC) REFERENCES clase(id_claseC),
